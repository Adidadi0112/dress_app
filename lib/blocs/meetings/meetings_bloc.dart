...
class MeetingsBloc extends Bloc<MeetingsEvent, MeetingsState> {
  ...
  Future<void> _onLoadMeetings(
      LoadMeetings event, Emitter<MeetingsState> emit) async {
  ...
  Future<void> _onAddMeeting(
      AddMeeting event, Emitter<MeetingsState> emit) async {
    try {
      emit(MeetingsLoading());
      ...
      if (result['type'] == 'success') {
        ...
        if (meetingsResult['type'] == 'success') {
          ...
          emit(MeetingActionSuccess(
              'Meeting created successfully!', updatedMeetings));
        } else {
  ...
  Future<void> _onUpdateMeeting(
      UpdateMeeting event, Emitter<MeetingsState> emit) async {
    try {
      emit(MeetingsLoading());

      final result = await _firestoreService.updateMeeting(
          event.meeting.id, event.meeting);
      ...
      if (result['type'] == 'success') {
        ...
        if (meetingsResult['type'] == 'success') {
          ...
          emit(MeetingActionSuccess(
              'Meeting updated successfully!', updatedMeetings));
        } else {
  ...
  Future<void> _onDeleteMeeting(
      DeleteMeeting event, Emitter<MeetingsState> emit) async {
    try {
      emit(MeetingsLoading());
      ...
      if (result['type'] == 'success') {
        ...
        if (meetingsResult['type'] == 'success') {
          ...
          emit(MeetingActionSuccess(
              'Meeting deleted successfully!', updatedMeetings));
        } else {
  ...
  Future<void> _onAddFriendToMeeting(
      AddFriendToMeeting event, Emitter<MeetingsState> emit) async {
    try {
      ...
      if (result['type'] == 'success') {
        ...
        if (meetingsResult['type'] == 'success') {
          ...
          emit(MeetingActionSuccess(
              'Friend added to meeting successfully!', updatedMeetings));
        }
      } else {
        emit(MeetingsError(result['message']));
      }
  ...
  Future<void> _onRemoveFriendFromMeeting(
      RemoveFriendFromMeeting event, Emitter<MeetingsState> emit) async {
    try {
      ...
      if (result['type'] == 'success') {
        ...
        if (meetingsResult['type'] == 'success') {
          ...
          emit(MeetingActionSuccess(
              'Friend removed from meeting successfully!', updatedMeetings));
        }
      } else {
        emit(MeetingsError(result['message']));
      }
